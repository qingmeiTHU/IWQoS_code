...
def cal():
	...
	for file in files:
		...
		for bw in Bandwidth:
			all_bandwidth.append((bw-average)/average+1.0)
	...
	for file in files:
		...
		for bw in Bandwidth:
			fcc_bandwidth.append((bw-average)/average+1.0)
	fcc_bandwidth.sort()
	...
	for file in files:
		...
		for bw in Bandwidth:
			nor_bandwidth.append((bw-average)/average+1.0)

	plt.plot([1,1],[0,1],'r',linestyle=':')
	nor_bandwidth.sort()
